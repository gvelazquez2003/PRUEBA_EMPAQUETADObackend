...
CREATE INDEX idx_salidas09_facturas_documento ON salidas_facturas(documento);
CREATE UNIQUE INDEX idx_salidas09_facturas_documento_numero ON salidas_facturas(documento, numero_factura);
